...
class TestIdentifierResolution(unittest.TestCase):
    ...
    def test_parse_load_statements_single_line(self):
        ...
        self.assertEqual(result["sharding_srcs"], "jstests/suites/selectors.bzl")
        self.assertEqual(result["core_srcs"], "jstests/suites/selectors.bzl")
...
"""
        ...
        self.assertEqual(result["sharding_srcs"], "jstests/suites/selectors.bzl")
        self.assertEqual(result["core_tests"], "jstests/core/tests.bzl")
    ...
    def test_parse_load_statements_relative_path(self):
        ...
        self.assertEqual(result["local_srcs"], "buildscripts/resmokeconfig/local_defs.bzl")
